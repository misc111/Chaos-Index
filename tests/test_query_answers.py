...
def test_query_answers(tmp_path: Path):
    ...
    db.executemany(
        ...
        """,
        [
            (10, "2026-03-01T00:00:00Z", "2026-03-05", "TOR", "MTL", 0.62, "TOR", '{"glm_logit":0.61}', 0.55, 0.61, 0.66, 0.61, 0.03, 0.04, 0.54, 0.69, '{"starter_unknown":true}', "s1", "f1", "r1"),
            (11, "2026-03-01T00:00:00Z", "2026-03-06", "BOS", "NJD", 0.57, "BOS", '{"glm_logit":0.58}', 0.50, 0.57, 0.61, 0.56, 0.02, 0.03, 0.49, 0.64, '{"starter_unknown":false}', "s1", "f1", "r1"),
            (12, "2026-03-01T00:00:00Z", "2026-03-07", "TBL", "FLA", 0.55, "TBL", '{"glm_logit":0.56}', 0.49, 0.55, 0.60, 0.55, 0.02, 0.03, 0.48, 0.62, '{"starter_unknown":false}', "s1", "f1", "r1"),
            (13, "2026-03-01T00:00:00Z", "2026-03-06", "BOS", "TOR", 0.57, "BOS", '{"glm_logit":0.57}', 0.50, 0.56, 0.61, 0.56, 0.03, 0.04, 0.49, 0.63, '{"starter_unknown":false}', "s1", "f1", "r1"),
            (14, "2026-03-01T00:00:00Z", "2026-03-07", "TOR", "OTT", 0.54, "TOR", '{"glm_logit":0.55}', 0.49, 0.54, 0.60, 0.54, 0.03, 0.04, 0.47, 0.61, '{"starter_unknown":false}', "s1", "f1", "r1"),
            (20, "2026-03-01T00:00:00Z", "2026-03-05", "NYK", "CHI", 0.59, "NYK", '{"glm_logit":0.60}', 0.52, 0.59, 0.64, 0.58, 0.02, 0.03, 0.51, 0.66, '{"injury_noise":false}', "s1", "f1", "r1"),
            (21, "2026-03-01T00:00:00Z", "2026-03-06", "MIA", "NYK", 0.56, "MIA", '{"glm_logit":0.57}', 0.50, 0.56, 0.61, 0.56, 0.02, 0.03, 0.49, 0.63, '{"injury_noise":false}', "s1", "f1", "r1"),
        ],
    )
    ...
    db.executemany(
        ...
        """,
        [
            (1, "glm_logit", "r1", "2026-02-01T00:00:00Z", "2026-02-02", 0.6, 1, 0.51, 0.16, 1, "2026-02-03T00:00:00Z"),
