...
- Prefer `npm run test:unit` for server/component contract changes, `npm run lint` for lint-sensitive edits, and `npm run typecheck` for TypeScript contract changes. Do not use Playwright for browser-facing flow checks.
