...
ESPN_NCAAM_SUMMARY_URL = "https://site.api.espn.com/apis/site/v2/sports/basketball/mens-college-basketball/summary"
...
def fetch_goalie_game_stats(
    ...
    for game_id in selected_game_ids:
        try:
            payload, raw_path = client.get_json("ncaam_goalies", ESPN_NCAAM_SUMMARY_URL, params={"event": int(game_id)}, key=str(game_id))
            ...
            rows.append(
                {
                    ...
                    "toi_minutes": None,
                    "decision": None,
                    "shots_for": team_row.get("fga"),
                    "penalties_taken": team_row.get("fouls"),
                    "penalties_drawn": opp.get("fouls"),
                    "pp_goals": team_row.get("ftm") or 0,
                }
            )
    ...
    snapshot_id = client.snapshot_id("ncaam_goalies", metadata)
    return SourceFetchResult(
        source="ncaam_goalies",
