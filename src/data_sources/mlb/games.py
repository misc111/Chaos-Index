...
def fetch_games(client: HttpClient, start_date: datetime, end_date: datetime) -> SourceFetchResult:
    ...
    while cursor <= end:
        ...
        payload, raw_path = client.get_json("mlb_games", ESPN_MLB_SCOREBOARD_URL, params={"dates": date_str}, key=date_str)
    ...
    snapshot_id = client.snapshot_id("mlb_games", metadata)
...
def fetch_recent_games(client: HttpClient, history_days: int = 365) -> SourceFetchResult:
