...
ESPN_MLB_TEAMS_URL = "https://site.api.espn.com/apis/site/v2/sports/baseball/mlb/teams"
...
def fetch_teams(client: HttpClient, as_of_date: str | None = None) -> SourceFetchResult:
    ...
    payload, raw_path = client.get_json("mlb_teams", ESPN_MLB_TEAMS_URL, key=as_of_date)
    ...
    snapshot_id = client.snapshot_id("mlb_teams", metadata)
