...
def fetch_games(client: HttpClient, start_date: datetime, end_date: datetime) -> SourceFetchResult:
    ...
    while cursor <= end:
        ...
        payload, raw_path = client.get_json("nba_games", ESPN_NBA_SCOREBOARD_URL, params={"dates": date_str}, key=date_str)
    ...
    snapshot_id = client.snapshot_id("nba_games", metadata)
