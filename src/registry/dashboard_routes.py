...
DASHBOARD_ROUTE_REGISTRY: tuple[DashboardRouteRegistryEntry, ...] = (
    ...
    DashboardRouteRegistryEntry(
        ...
        api_path="/api/research-admin",
        page_path="/research-admin",
        staging_file_name="research-admin.json",
        payload_contract="researchAdmin",
    ...
    DashboardRouteRegistryEntry(
        ...
        module_path="app/api/research-desk/route.ts",
        api_path="/api/research-desk",
        page_path="/research-desk",
        staging_file_name="research-desk.json",
        payload_contract="researchDesk",
    ),
    DashboardRouteRegistryEntry(
        key="performance",
